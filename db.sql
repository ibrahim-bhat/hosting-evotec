...
CREATE TABLE `hosting_orders` (
  ...
  `setup_fee` decimal(10,2) NOT NULL DEFAULT 0.00 COMMENT 'Captured from global settings at time of order',
  `gst_amount` decimal(10,2) NOT NULL DEFAULT 0.00 COMMENT 'Captured from global settings at time of order',
  `processing_fee` decimal(10,2) NOT NULL DEFAULT 0.00 COMMENT 'Captured from global settings at time of order',
